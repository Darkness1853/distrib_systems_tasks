...
class ProductsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateProduct = channel.unary_unary(
                ...
                request_serializer=service__pb2.CreateProductRequest.SerializeToString,
...
def add_ProductsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateProduct': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.CreateProductRequest.FromString,
...
class ProductsService(object):
    ...
    def CreateProduct(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/products.v1.ProductsService/CreateProduct',
            service__pb2.CreateProductRequest.SerializeToString,
